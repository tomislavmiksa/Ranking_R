...
##########################################
con <- dbConnect(odbc::odbc(),.connection_string = 'driver={SQL Server};server=blndb11;database=DE_BM_Voice_04;trusted_connection=true')
...
write.csv(kpiReport, file = "TEF-Q3-FinalTable.csv")
# Disconnect Database
##########################################
